...
<body>
 ...
 <!--             <h1 class="display-3">Heading Three</h1>
            ...
            <div class="col-4 pt-4 ml-auto d-none d-xl-block">
              <div class="packages-pricing">
                <div class="card text-center">
                  ...
                  <div class="card-body">
                    <p class="lead text-muted"><i class="fa fa-cog"></i> ARK TOURS & TRAVELS</p>
                    <p class="lead text-muted"><i class="fa fa-star"></i> Packages for all over the world</p>
                    <p class="lead text-muted"><i class="fa fa-plane"></i> Cab, Hotel, Cottages, Cruize .. etc</p>
                    <p class="lead text-muted"><i class="fa fa-automobile"></i> all are available. Just Book us Now</p>
                  </div>
  ...
  <!-- INDIA PACKAGES -->
  <section class="packages py-5 text-center" id="DomesticTourPackages">
    <div class="container">
      <h2 class="text-primary">Domestic Tour Packages</h2>
      <p>India and its heritage culture</p>
    </div>
    <!-- tour carousel -->
