            ...
            while ($row = $result->fetch_array()) :
              if ($i < $col) :
                ...
                <div class="card p-2 mr-2" style="max-width: 272px;">
                  <a href="view_packagesNE.php?id=<?php echo $row['id'] ?>"><img src="slider_images/<?php echo $row['img_url'] ?>" style="max-width: 258px; max-height: 169px;" class="card-img-top img-fluid"></a>
