        ...
        if (isset($_SESSION['mail_status'])) :
            ...
            <?php
                ...
                <div class="alert alert-danger alert-dismissible">
                    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                    <strong>Failed!</strong> Your mail was not sent, contact admin
                </div>
                    ...
                    <div class="modal-content">
                        ...
                        <form action="public_process.php" method="post">
                            <div class="modal-body">
                                ...
                                <input type="hidden" name="from_page" value="view_packages.php?id=<?php echo $p_id ?>">
                                <div class="form-group">
            ...
            <div class="tab-content">
                ...
                <!-- <tr>
                                                        ...
                                                        <td><? //php echo $row['budget'] 
                                                            ?></td>
                                                        <td><? //php echo $row['standard'] 
                                                            ?></td>
                                                        <td><? //php echo $row['deluxe'] 
                                                            ?></td>
                                                    </tr> -->
                ...
                <!-- <tr>
                                                        <td><? //php echo $row['category'] 
                                                            ?></td>
                                                        <td><? //php echo $row['based_on_2_pax'] 
                                                            ?></td>
                                                        <td><? //php echo $row['based_on_4_pax'] 
                                                            ?></td>
                                                        <td><? //php echo $row['based_on_6_pax'] 
                                                            ?></td>
                                                    </tr> -->
...
<script>
    ...
    $(document).ready(function() {
        //for closing alert box after some seconds

        setTimeout(() => {
            $(".alert").alert('close');
        }, 3000);

        //for opening contact form on condition
        let contactNowSubmited = false;

        <?php
        if (isset($_SESSION['mail_status'])) :
            ?>
            contactNowSubmited = true;
            <?php
